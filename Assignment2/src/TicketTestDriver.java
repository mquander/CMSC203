...
public class TicketTestDriver
{
	public static void main(String[] args)
	{
		...
		//test calculateFine
		if(!(300.0==ticket1.calculateFine())) print("calculateFine Error 1");
		if(!(450.0==ticket2.calculateFine())) print("calculateFine Error 2");
		if(!(600.0==ticket3.calculateFine())) print("calculateFine Error 3");
		...
		if(!(scan.nextLine().contains("fine of $300.00"))) print("printNotice Error 3");
